...
function UploadSection() {
  ...
  try {
    ...
    const originalImageURL = `http://localhost:7000/upload/${data.predicted_image_url}`;
    const predictedImageURL = `http://localhost:7000/predict/${data.predicted_image_url}`;
